// $ANTLR 3.5.2 org/antlr/v4/codegen/SourceGenTriggers.g 2021-03-08 23:57:03
...
public class SourceGenTriggers extends TreeParser {
	...
	// $ANTLR start "dummy"
	// org/antlr/v4/codegen/SourceGenTriggers.g:35:1: dummy : block[null, null] ;
	public final void dummy() throws RecognitionException {
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:35:7: ( block[null, null] )
			// org/antlr/v4/codegen/SourceGenTriggers.g:35:9: block[null, null]
			{
	...
	// $ANTLR start "block"
	// org/antlr/v4/codegen/SourceGenTriggers.g:37:1: block[GrammarAST label, GrammarAST ebnfRoot] returns [List<? extends SrcOp> omos] : ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ ) ;
	public final List<? extends SrcOp> block(GrammarAST label, GrammarAST ebnfRoot) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:38:5: ( ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ ) )
			// org/antlr/v4/codegen/SourceGenTriggers.g:38:7: ^(blk= BLOCK ( ^( OPTIONS ( . )+ ) )? ( alternative )+ )
			{
			blk=(GrammarAST)match(input,BLOCK,FOLLOW_BLOCK_in_block84); 
			match(input, Token.DOWN, null); 
			// org/antlr/v4/codegen/SourceGenTriggers.g:38:20: ( ^( OPTIONS ( . )+ ) )?
			int alt2=2;
			...
			switch (alt2) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:38:21: ^( OPTIONS ( . )+ )
					{
					match(input,OPTIONS,FOLLOW_OPTIONS_in_block88); 
					match(input, Token.DOWN, null); 
					// org/antlr/v4/codegen/SourceGenTriggers.g:38:31: ( . )+
					int cnt1=0;
					loop1:
					while (true) {
						int alt1=2;
			...
			// org/antlr/v4/codegen/SourceGenTriggers.g:40:7: ( alternative )+
			int cnt3=0;
			loop3:
			while (true) {
				int alt3=2;
				...
				switch (alt3) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:40:9: alternative
					{
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:55:1: alternative returns [CodeBlockForAlt altCodeBlock, List<SrcOp> ops] : a= alt[outerMost] ;
	public final SourceGenTriggers.alternative_return alternative() throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:62:5: (a= alt[outerMost] )
			// org/antlr/v4/codegen/SourceGenTriggers.g:62:7: a= alt[outerMost]
			{
	...
	// $ANTLR start "alt"
	// org/antlr/v4/codegen/SourceGenTriggers.g:65:1: alt[boolean outerMost] returns [CodeBlockForAlt altCodeBlock, List<SrcOp> ops] : ( ^( ALT ( elementOptions )? ( element )+ ) | ^( ALT ( elementOptions )? EPSILON ) );
	public final SourceGenTriggers.alt_return alt(boolean outerMost) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:71:2: ( ^( ALT ( elementOptions )? ( element )+ ) | ^( ALT ( elementOptions )? EPSILON ) )
			int alt7=2;
			alt7 = dfa7.predict(input);
			switch (alt7) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:71:4: ^( ALT ( elementOptions )? ( element )+ )
					{
					...
					match(input, Token.DOWN, null); 
					// org/antlr/v4/codegen/SourceGenTriggers.g:78:10: ( elementOptions )?
					int alt4=2;
					...
					// org/antlr/v4/codegen/SourceGenTriggers.g:78:26: ( element )+
					int cnt5=0;
					loop5:
					while (true) {
						int alt5=2;
						...
						switch (alt5) {
						case 1 :
							// org/antlr/v4/codegen/SourceGenTriggers.g:78:28: element
							{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:80:4: ^( ALT ( elementOptions )? EPSILON )
					{
					match(input,ALT,FOLLOW_ALT_in_alt212); 
					match(input, Token.DOWN, null); 
					// org/antlr/v4/codegen/SourceGenTriggers.g:80:10: ( elementOptions )?
					int alt6=2;
	...
	// $ANTLR start "element"
	// org/antlr/v4/codegen/SourceGenTriggers.g:84:1: element returns [List<? extends SrcOp> omos] : ( labeledElement | atom[null,false] | subrule | ACTION | SEMPRED | ^( ACTION elementOptions ) | ^( SEMPRED elementOptions ) );
	public final List<? extends SrcOp> element() throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:85:2: ( labeledElement | atom[null,false] | subrule | ACTION | SEMPRED | ^( ACTION elementOptions ) | ^( SEMPRED elementOptions ) )
			int alt8=7;
			switch ( input.LA(1) ) {
			case ASSIGN:
			case PLUS_ASSIGN:
			...
			switch (alt8) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:85:4: labeledElement
					{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:86:4: atom[null,false]
					{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:87:4: subrule
					{
					...
					break;
				case 4 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:88:6: ACTION
					{
					...
					break;
				case 5 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:89:6: SEMPRED
					{
					...
					break;
				case 6 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:90:4: ^( ACTION elementOptions )
					{
					...
					break;
				case 7 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:91:6: ^( SEMPRED elementOptions )
					{
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:94:1: labeledElement returns [List<? extends SrcOp> omos] : ( ^( ASSIGN ID atom[$ID,false] ) | ^( PLUS_ASSIGN ID atom[$ID,false] ) | ^( ASSIGN ID block[$ID,null] ) | ^( PLUS_ASSIGN ID block[$ID,null] ) );
	public final List<? extends SrcOp> labeledElement() throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:95:2: ( ^( ASSIGN ID atom[$ID,false] ) | ^( PLUS_ASSIGN ID atom[$ID,false] ) | ^( ASSIGN ID block[$ID,null] ) | ^( PLUS_ASSIGN ID block[$ID,null] ) )
			int alt9=4;
			...
			switch (alt9) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:95:4: ^( ASSIGN ID atom[$ID,false] )
					{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:96:4: ^( PLUS_ASSIGN ID atom[$ID,false] )
					{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:97:4: ^( ASSIGN ID block[$ID,null] )
					{
					...
					break;
				case 4 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:98:4: ^( PLUS_ASSIGN ID block[$ID,null] )
					{
	...
	// $ANTLR start "subrule"
	// org/antlr/v4/codegen/SourceGenTriggers.g:101:1: subrule returns [List<? extends SrcOp> omos] : ( ^( OPTIONAL b= block[null,$OPTIONAL] ) | ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) ) | block[null, null] );
	public final List<? extends SrcOp> subrule() throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:102:2: ( ^( OPTIONAL b= block[null,$OPTIONAL] ) | ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) ) | block[null, null] )
			int alt11=3;
			switch ( input.LA(1) ) {
			case OPTIONAL:
				{
			...
			switch (alt11) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:102:4: ^( OPTIONAL b= block[null,$OPTIONAL] )
					{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:106:4: ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) )
					{
					// org/antlr/v4/codegen/SourceGenTriggers.g:106:4: ( ^(op= CLOSURE b= block[null,null] ) | ^(op= POSITIVE_CLOSURE b= block[null,null] ) )
					int alt10=2;
					...
					switch (alt10) {
						case 1 :
							// org/antlr/v4/codegen/SourceGenTriggers.g:106:6: ^(op= CLOSURE b= block[null,null] )
							{
							...
							break;
						case 2 :
							// org/antlr/v4/codegen/SourceGenTriggers.g:107:5: ^(op= POSITIVE_CLOSURE b= block[null,null] )
							{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:119:5: block[null, null]
					{
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:122:1: blockSet[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ^( SET ( atom[label,invert] )+ ) ;
	public final List<SrcOp> blockSet(GrammarAST label, boolean invert) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:123:5: ( ^( SET ( atom[label,invert] )+ ) )
			// org/antlr/v4/codegen/SourceGenTriggers.g:123:7: ^( SET ( atom[label,invert] )+ )
			{
			SET20=(GrammarAST)match(input,SET,FOLLOW_SET_in_blockSet506); 
			match(input, Token.DOWN, null); 
			// org/antlr/v4/codegen/SourceGenTriggers.g:123:13: ( atom[label,invert] )+
			int cnt12=0;
			loop12:
			while (true) {
				int alt12=2;
	...
	// $ANTLR start "atom"
	// org/antlr/v4/codegen/SourceGenTriggers.g:136:1: atom[GrammarAST label, boolean invert] returns [List<SrcOp> omos] : ( ^( NOT a= atom[$label, true] ) | range[label] | ^( DOT ID terminal[$label] ) | ^( DOT ID ruleref[$label] ) | ^( WILDCARD . ) | WILDCARD | terminal[label] | ruleref[label] | blockSet[$label, invert] );
	public final List<SrcOp> atom(GrammarAST label, boolean invert) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:137:2: ( ^( NOT a= atom[$label, true] ) | range[label] | ^( DOT ID terminal[$label] ) | ^( DOT ID ruleref[$label] ) | ^( WILDCARD . ) | WILDCARD | terminal[label] | ruleref[label] | blockSet[$label, invert] )
			int alt13=9;
			switch ( input.LA(1) ) {
			case NOT:
				{
			...
			switch (alt13) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:137:4: ^( NOT a= atom[$label, true] )
					{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:138:4: range[label]
					{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:139:4: ^( DOT ID terminal[$label] )
					{
					...
					break;
				case 4 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:140:4: ^( DOT ID ruleref[$label] )
					{
					...
					break;
				case 5 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:141:7: ^( WILDCARD . )
					{
					...
					break;
				case 6 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:142:7: WILDCARD
					{
					...
					break;
				case 7 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:143:9: terminal[label]
					{
					...
					break;
				case 8 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:144:9: ruleref[label]
					{
					...
					break;
				case 9 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:145:4: blockSet[$label, invert]
					{
	...
	// $ANTLR start "ruleref"
	// org/antlr/v4/codegen/SourceGenTriggers.g:148:1: ruleref[GrammarAST label] returns [List<SrcOp> omos] : ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? ) ;
	public final List<SrcOp> ruleref(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:149:5: ( ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? ) )
			// org/antlr/v4/codegen/SourceGenTriggers.g:149:7: ^( RULE_REF ( ARG_ACTION )? ( elementOptions )? )
			{
			RULE_REF27=(GrammarAST)match(input,RULE_REF,FOLLOW_RULE_REF_in_ruleref685); 
			if ( input.LA(1)==Token.DOWN ) {
				match(input, Token.DOWN, null); 
				// org/antlr/v4/codegen/SourceGenTriggers.g:149:18: ( ARG_ACTION )?
				int alt14=2;
				...
				// org/antlr/v4/codegen/SourceGenTriggers.g:149:30: ( elementOptions )?
				int alt15=2;
	...
	// $ANTLR start "range"
	// org/antlr/v4/codegen/SourceGenTriggers.g:152:1: range[GrammarAST label] returns [List<SrcOp> omos] : ^( RANGE a= STRING_LITERAL b= STRING_LITERAL ) ;
	public final List<SrcOp> range(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:153:5: ( ^( RANGE a= STRING_LITERAL b= STRING_LITERAL ) )
			// org/antlr/v4/codegen/SourceGenTriggers.g:153:7: ^( RANGE a= STRING_LITERAL b= STRING_LITERAL )
			{
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:156:1: terminal[GrammarAST label] returns [List<SrcOp> omos] : ( ^( STRING_LITERAL . ) | STRING_LITERAL | ^( TOKEN_REF ARG_ACTION . ) | ^( TOKEN_REF . ) | TOKEN_REF );
	public final List<SrcOp> terminal(GrammarAST label) throws RecognitionException {
		...
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:157:5: ( ^( STRING_LITERAL . ) | STRING_LITERAL | ^( TOKEN_REF ARG_ACTION . ) | ^( TOKEN_REF . ) | TOKEN_REF )
			int alt16=5;
			...
			switch (alt16) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:157:8: ^( STRING_LITERAL . )
					{
					...
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:158:7: STRING_LITERAL
					{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:159:7: ^( TOKEN_REF ARG_ACTION . )
					{
					...
					break;
				case 4 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:160:7: ^( TOKEN_REF . )
					{
					...
					break;
				case 5 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:161:7: TOKEN_REF
					{
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:164:1: elementOptions : ^( ELEMENT_OPTIONS ( elementOption )+ ) ;
	public final void elementOptions() throws RecognitionException {
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:165:5: ( ^( ELEMENT_OPTIONS ( elementOption )+ ) )
			// org/antlr/v4/codegen/SourceGenTriggers.g:165:7: ^( ELEMENT_OPTIONS ( elementOption )+ )
			{
			match(input,ELEMENT_OPTIONS,FOLLOW_ELEMENT_OPTIONS_in_elementOptions836); 
			match(input, Token.DOWN, null); 
			// org/antlr/v4/codegen/SourceGenTriggers.g:165:25: ( elementOption )+
			int cnt17=0;
			loop17:
			while (true) {
				int alt17=2;
	...
	// org/antlr/v4/codegen/SourceGenTriggers.g:168:1: elementOption : ( ID | ^( ASSIGN ID ID ) | ^( ASSIGN ID STRING_LITERAL ) | ^( ASSIGN ID ACTION ) | ^( ASSIGN ID INT ) );
	public final void elementOption() throws RecognitionException {
		try {
			// org/antlr/v4/codegen/SourceGenTriggers.g:169:5: ( ID | ^( ASSIGN ID ID ) | ^( ASSIGN ID STRING_LITERAL ) | ^( ASSIGN ID ACTION ) | ^( ASSIGN ID INT ) )
			int alt18=5;
			...
			switch (alt18) {
				case 1 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:169:7: ID
					{
					match(input,ID,FOLLOW_ID_in_elementOption857); 
					}
					break;
				case 2 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:170:9: ^( ASSIGN ID ID )
					{
					...
					break;
				case 3 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:171:9: ^( ASSIGN ID STRING_LITERAL )
					{
					...
					break;
				case 4 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:172:9: ^( ASSIGN ID ACTION )
					{
					...
					break;
				case 5 :
					// org/antlr/v4/codegen/SourceGenTriggers.g:173:9: ^( ASSIGN ID INT )
					{
